package com.henry.tutorial_01.about_language;

import java.time.LocalDate;
import java.util.Date;

import com.henry.tutorial_02.about_static.DepartmentProcessor;

public class BasicLanguageExample {
	...
	public static void main(String[]args ) {
		...
		IntegerTuple intTuple = new IntegerTuple(1,2);	//declare custom type by declaring the class first
